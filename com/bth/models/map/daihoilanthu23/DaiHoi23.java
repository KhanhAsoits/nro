...
import com.bth.models.boss.list_boss.dhvt.*;
...
//                endChallenge();
                ...
                DaiHoi23Manager.gI().remove(this);
            }
    ...
    public void ready() {
        ...
        Util.setTimeout(() -> {
            ...
            DaiHoi23Service.gI().sendTypePK(player, boss);
    ...
    public void toTheNextRound() {
        try {
            ...
            DaiHoi23Service.gI().moveFast(player, 335, 264);
            setTimeWait(11);
            setBoss(bss);
            setTime(185);
        } catch (Exception e) {
...
//        }
    ...
    private void reward() {
        if (player.levelruonggo < round) {
            player.levelruonggo = round;
        }
    }
