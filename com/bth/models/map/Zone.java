package com.bth.models.map;

import com.bth.consts.ConstPlayer;
import com.bth.consts.ConstTask;
import com.bth.models.boss.list_boss.dhvt.BossDHVT;
...
//            Logger.logException(MapService.class, e);
        ...
        if (!plInfo.isBoss && !plInfo.isPet &&!plInfo.isNewPet&&!(plInfo instanceof BossDHVT)&&!(plInfo instanceof TrongTai)) {
