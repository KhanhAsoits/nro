...
import com.bth.models.boss.iboss.IBossNew;
import com.bth.models.boss.iboss.IBossOutfit;
 ...
 * 
 */
public abstract class Boss extends Player implements IBossNew, IBossOutfit {
    ...
    public Boss(int id, BossData... data) {
        ...
        if (data == null || data.length == 0) {
           System.out.println("Dữ liệu boss không hợp lệ");
        }
        this.data = data;
    ...
    public void changeToTypeBossSolo() {
...
//        System.out.println("this status: " + this.bossStatus + " (" + this.id + ")");
    ...
    protected void notifyJoinMap() {
        ...
        if (this.zone.map.mapId == 140||this.zone.map.mapId == 135||MapService.gI().isMapMaBu(this.zone.map.mapId) || MapService.gI().isMapBlackBallWar(this.zone.map.mapId))
            return;
