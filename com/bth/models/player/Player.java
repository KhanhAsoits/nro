...
import com.bth.models.intrinsic.IntrinsicPlayer;
...
import com.bth.models.map.vodaibahatmit.FightBossBahatmit;
import com.bth.models.matches.IPVP;
import com.bth.models.matches.TYPE_LOSE_PVP;
import com.bth.models.mob.MobMe;
...
import com.bth.models.skill.PlayerSkill;
import com.bth.models.skill.Skill;
import com.bth.services.EffectSkillService;
import com.bth.models.task.TaskPlayer;
...
import com.bth.services.func.CombineNew;
import com.bth.services.func.ChonAiDay;
...
public class Player {
    ...
    public int levelruonggo;
    public boolean checkruonggo;
    public int golddaihoi;
    public List<String> textRuongGo = new ArrayList<>();
    public int diemthuytinh;
    public int diemsontinh;
    ...
    public void update() {
        if (!this.beforeDispose && this!=null) {
            try {
                if (!iDMark.isBan()) {
                    ...
                    if (this.iDMark.isGoToBDKB() && this.iDMark!= null && Util.canDoWithTime(this.iDMark.getLastTimeGoToBDKB(), 6000)) {
                        ChangeMapService.gI().changeMapBySpaceShip(this, 135, -1, 35);
                        this.iDMark.setGoToBDKB(false);
                    }
                    if (this.iDMark.isGoTokhiga() && this.iDMark!= null && Util.canDoWithTime(this.iDMark.getLastTimeGoTokhiga(), 6000)) {
                        ChangeMapService.gI().changeMapBySpaceShip(this, 149, -1, 35);
                        this.iDMark.setGoTokhiga(false);
                    }
                    if (this.zone != null) {
    ...
    public byte getAura() {
        ...
        if (item.template.id == 1202) {
            return 57;
        } else if (item.template.id == 1124) {
            return 1;
    ...
    public int injured(Player plAtt, int damage, boolean piercing, boolean isMobAttack) {
        if (!this.isDie()) {
            ...
            //if (isMobAttack && this.effectSkill.isCaiBinhChua) {
                //damage = this.mobMe.id - this.nPoint.hp *1/100;
            //}
