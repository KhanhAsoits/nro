...
public class NPoint {
    ...
    private void setDameTrainArmor() {
        if (!this.player.isPet && !this.player.isNewPet && !this.player.isBoss) {
    ...
    private void setHpMax() {
        ...
        if (this.player.effectSkill.isMonkey) {
            if (!this.player.isPet && !this.player.isNewPet || (this.player.isPet
        ...
        //huýt sáo
        if (!this.player.isPet && !this.player.isNewPet
                || (this.player.isPet
                && ((Pet) this.player).status != Pet.FUSION)) {
        ...
        if (this.player.itemTime != null && this.player.itemTime.hp20pt8_3) {
            this.hpMax += ((long) this.hpMax * 20 / 100);
        }
        //mèo mun
    ...
    private void setMpMax() {
        ...
        if (this.player.itemTime != null && this.player.itemTime.ki20pt8_3) {
            this.mpMax += ((long) this.mpMax * 20 / 100);
        }
        //phù
        if (this.player.zone != null && MapService.gI().isMapBlackBallWar(this.player.zone.map.mapId)) {
    ...
    private void setDame() {
        ...
        //thức ăn
        if (!this.player.isPet && !this.player.isNewPet && this.player.itemTime.isEatMeal
        ...
        if (this.player.itemTime != null && this.player.itemTime.sd20pt8_3) {
            this.dame += this.dame* 20 / 100;
        }
        //giảm dame
