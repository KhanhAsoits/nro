...
import com.bth.models.item.ItemTime;
import com.bth.models.skill.Skill;
import com.bth.models.task.TaskMain;
import com.bth.services.ClanService;
            ...
            if (rs.first()) {
                ...
                if (rs.getBoolean("ban")) {
                    ...
                    if (plInGame != null) {
                        ...
                        Service.getInstance().sendThongBaoOK(session, "Tài khoản đang được đăng nhập");
                    } else {
                    }
                } else {
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            player.gdvip = rs.getInt("gdvip");
                            player.NguHanhSonPoint = rs.getInt("NguHanhSonPoint");
                            player.diemtanghoa8_3 = rs.getInt("diemtanghoa8_3");
                            ...
                            player.inventory.gold = Long.valueOf(String.valueOf(dataArray.get(0)));
                            ...
                            try {
                                ...
                                if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapBlackBallWar(mapId)
                                        || MapService.gI().isMapBanDoKhoBau(mapId) || MapService.gI().isMapKhiGa(mapId) || MapService.gI().isMapMaBu(mapId)|| MapService.gI().isMapTatCo(mapId)) {
...
//                            int timeMayDo2 = Integer.parseInt(String.valueOf(dataArray.get(10)));    
                            ...
                            //data sukien 8_3
                            dataArray = (JSONArray) jv.parse(rs.getString("timequa8_3"));
                            int sd20pt = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            int hp20pt = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            int ki20pt = Integer.parseInt(String.valueOf(dataArray.get(2)));

                            player.itemTime.lastsd20pt8_3 = System.currentTimeMillis() - (ItemTime.MUOILAMPHUT - sd20pt);
                            player.itemTime.lasthp20pt8_3 = System.currentTimeMillis() - (ItemTime.MUOILAMPHUT - hp20pt);
                            player.itemTime.lastki20pt8_3 = System.currentTimeMillis() - (ItemTime.MUOILAMPHUT - ki20pt);

                            player.itemTime.sd20pt8_3 = sd20pt != 0;
                            player.itemTime.hp20pt8_3 = hp20pt != 0;
                            player.itemTime.ki20pt8_3 = ki20pt != 0;
                            dataArray.clear();
                            ...
                            //data dua hau
                            dataArray = (JSONArray) jv.parse(rs.getString("data_dua_hau"));
                            if (dataArray.size() != 0) {
                                player.duahau = new DuaHau(player, Long.parseLong(String.valueOf(dataArray.get(0))),
                                        Long.parseLong(String.valueOf(dataArray.get(1))));
                            }
                            dataArray.clear();
                            ...
                            //data giỗ tổ
                            dataArray = (JSONArray) jv.parse(rs.getString("data_diem_gioto"));
                            player.diemsontinh = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.diemthuytinh = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            dataArray.clear();
        ...
        try {
            ...
            if (rs.first()) {
                ...
                try {
                    ...
                    player.location.y = Integer.parseInt(String.valueOf(dataArray.get(2)));
                    if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapBlackBallWar(mapId)
                            || MapService.gI().isMapBanDoKhoBau(mapId)|| MapService.gI().isMapKhiGa(mapId) ) {
                        mapId = player.gender + 21;
                        player.location.x = 300;
                        player.location.y = 336;
                    }
                ...
                player.itemTime.lastTimeOpenPower = System.currentTimeMillis() - (ItemTime.TIME_OPEN_POWER - timeOpenPower);
                player.itemTime.lastTimeUseMayDo = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeMayDo);
                player.itemTime.lastTimeUseMayDo2 = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeMayDo2);
                player.itemTime.lastTimeEatMeal = System.currentTimeMillis() - (ItemTime.TIME_EAT_MEAL - timeMeal);
                player.itemTime.iconMeal = iconMeal;
                player.itemTime.isUseBoHuyet = timeBoHuyet != 0;
                player.itemTime.isUseBoKhi = timeBoKhi != 0;
