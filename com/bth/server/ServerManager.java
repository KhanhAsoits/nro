...
import com.bth.jdbc.daos.HistoryTransactionDAO;
...
import com.bth.models.map.daihoi.DaiHoiService;
import com.bth.models.map.daihoilanthu23.DaiHoi23Manager;
import com.bth.models.player.Player;
import com.bth.server.io.MyKeyHandler;
...
public class ServerManager {
    ...
    public void run() {
        ...
        new Thread(() -> {
            while (isRunning) {
                try {
                    ...
                    DaiHoi23Manager.gI().update();
                    Service.getInstance().UpdatePlayerAuto();
        ...
        try {
            ...
            Manager.MAPS.forEach(com.bth.models.map.Map::initBoss);
        ...
        new Thread(() -> {
            ...
            while (true) {
                ...
                if (line.equals("baotri")) {
                    ...
                    ServerNotify.gI().notify("NROKURO debug server: " + Thread.activeCount());
                    Logger.error("NROKURO debug server: " + Thread.activeCount());
                } else if (line.equals("nplayer")) {
                    Logger.error("Player in game: " + Client.gI().getPlayers().size() + "\n");
                } else if (line.equals("online")) {
                    Logger.error("Số người online: " + Client.gI().getPlayers().size() + "\nSố thread: " + Thread.activeCount());
