...
public class ConstNpc {
    ...
    public static final byte BUNMA8_3 = 77;
    ...
    public static final int MENUSUKIENTET = 526;
    public static final int MENUSUKIEN8_3 = 527;
    public static final int MENUSUKIENGIOTO = 528;
    ...
    //khiga
    public static final int MENU_OPEN_KHIGA = 500;
    public static final int MENU_OPENED_KHIGA = 501;
    public static final int MENU_ACCEPT_GO_TO_KHIGA = 502;
    ...
    //index menu duahau
    public static final int NOT_NHAN_DUA = 500;
    public static final int CAN_THU_HOACH_DUA = 501;
    ...
    public static final int RUT_VANG = 66;
