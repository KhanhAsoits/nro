...
public class EffectSkillService {
    ...
    public static final byte ICE_EFFECT = 82;
    ...
    public void sendEffectUseSkill(Player player, byte skillId) {
        ...
        try {
            ...
            com.bth.utils.Logger.logException(EffectSkillService.class, e);
        }
    }
    ...
    public void setAnTroi(Player player, Player plTroi, long lastTimeAnTroi, int timeAnTroi) {
        ...
        player.effectSkill.lastTimeTroi = lastTimeAnTroi;
        player.effectSkill.timeTroi = timeAnTroi;
    ...
    public void SetHoaBang(Player player, long lastTimeHoaBang, int timeHoaBang){
        ...
        sendEffectPlayer(player, player, TURN_ON_EFFECT, ICE_EFFECT);
    ...
    public void sendMobToCaiBinh(Player player, Mob mob, int timeSocola) {
        ...
        try {
            ...
            message.writer().writeShort(11175); //icon cái bình
