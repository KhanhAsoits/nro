...
import com.bth.models.clan.ClanMessage;
...
import static com.bth.models.clan.Clan.*;
...
//                    askForPea(player);
        ...
        try {
            if (player.clan == null) {
                ...
                if (clan != null && clan.getCurrMembers() < clan.maxMember) {
                    ...
                    ItemTimeService.gI().sendTextKhiGa(player);
    ...
    private void createClan(Player player, byte imgId, String name) {
        if (player.clan == null) {
            ...
            Template.FlagBag flagBag = FlagBagService.gI().getFlagBag(imgId);
            if (flagBag != null) {
                if (flagBag.gold > 0) {
    ...
    public void leaveClan(Player player) {
        ...
        if (clan != null) {
            ...
            if (cm != null) {
                ...
                ItemTimeService.gI().removeTextBanDo(player);
    ...
    public void kickOut(Player player, int memberId) {
        ...
        if (clan != null && cm != null
            ...
            if (plKicked != null) {
                ...
                ItemTimeService.gI().removeTextBanDo(plKicked);
            } else {
...
//                ClanDAO.updateClanMember(cm);
    ...
    public void saveclanauto() {
        ...
        try (Connection con = GirlkunDB.getConnection();) {
            ...
            //Logger.log(Logger.YELLOW,"AUTO SAVE CLAN SUCCESS\n");
            ps.executeBatch();
            ps.close();
        } catch (Exception e) {
            Logger.logException(Clan.class, e, "Có lỗi khi update clan vào db");
