                ...
                case ADD_ITEM_TRADE:
                    if (trade != null) {
                        ...
                        if(pl.gdvip <= 0) {
                            ...
                            trade.addItemTradeVip(pl, index, quantity);
                            Service.getInstance().sendThongBaoFromAdmin(pl,
                                    "|7|NROKURO.COM Bạn đang chọn tính năng giao dịch vip mỗi một vật phẩm tương ứng mất đi 1 điểm giao dịch vip" +
                                            "\n|5|Số điểm giao dịch vip còn lại là "+pl.gdvip);
                            pl.gdvip--;
                        }
                        } else {
                            Service.getInstance().sendThongBaoFromAdmin(pl,
                                    "|5|VUI LÒNG KÍCH HOẠT TÀI KHOẢN TẠI\n|7|NROKURO.COM\n|5|ĐỂ MỞ KHÓA GIAO DỊCH VẬT PHẬM NÀY");
                            trade.cancelTrade();
                        }
                    }
                    break;
