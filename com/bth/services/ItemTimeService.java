...
import static com.bth.models.item.ItemTime.*;
...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.sd20pt8_3) {
            sendItemTime(player, 25555, (int) ((MUOILAMPHUT - (System.currentTimeMillis() - player.itemTime.lastsd20pt8_3)) / 1000));
        }
        if (player.itemTime.hp20pt8_3) {
            sendItemTime(player, 5206, (int) ((MUOILAMPHUT - (System.currentTimeMillis() - player.itemTime.lasthp20pt8_3)) / 1000));
        }
        if (player.itemTime.ki20pt8_3) {
            sendItemTime(player, 27777, (int) ((MUOILAMPHUT - (System.currentTimeMillis() - player.itemTime.lastki20pt8_3)) / 1000));
        }
    }
    ...
    public void sendTextKhiGa(Player player) {
        if (player.clan != null
                && player.clan.timekhiga != 0) {
            int secondPassed = (int) ((System.currentTimeMillis() - player.clan.timekhiga) / 1000);
            int secondsLeft = (KhiGa.TIME_KHIGA / 1000) - secondPassed;
            sendTextTime(player, KHIGA, "Khí Ga", secondsLeft);
        }
    }
